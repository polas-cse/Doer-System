-- DROP FUNCTION IF EXISTS create_quartz_schema();
CREATE OR REPLACE FUNCTION create_quartz_schema()
RETURNS void AS $quartz_schema$
    ...
    END;
$quartz_schema$ LANGUAGE plpgsql;
-- SELECT create_quartz_schema();
